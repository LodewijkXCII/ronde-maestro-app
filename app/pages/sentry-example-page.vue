...
<template>
  ...
  <div>
    <main>
      ...
      <p class="description">
        Click the button below, and view the sample error on the Sentry <a target="_blank" href="https://rondemaestro.sentry.io/issues/?project=4509830502154320">Issues Page</a>.
